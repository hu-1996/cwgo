...
func (arg *HzArgument) Parse(c *cli.Context, cmd string) (*HzArgument, error) {
...
func (arg *HzArgument) parseStringSlice(c *cli.Context) {
...
func (arg *HzArgument) UpdateByManifest(m *meta.Manifest) {
...
func (arg *HzArgument) checkPath() error {
	dir, err := os.Getwd()
	if err != nil {
...
func (arg *HzArgument) checkIDL() error {
...
func (arg *HzArgument) Pack() ([]string, error) {
...
func (arg *HzArgument) Unpack(data []string) error {
...
func (arg *HzArgument) Fork() *HzArgument {
	args := NewHzArgument()
	*args = *arg
...
func (arg *HzArgument) GetGoPackage() (string, error) {
	if arg.Gomod != "" {
...
func (arg *HzArgument) ModelPackagePrefix() (string, error) {
	ret := arg.Gomod
	if arg.ModelDir == "" {
...
func (arg *HzArgument) ModelOutDir() string {
	ret := arg.OutDir
	if arg.ModelDir == "" {
...
func (arg *HzArgument) GetHandlerDir() (string, error) {
	if arg.HandlerDir == "" {
...
func (arg *HzArgument) GetRouterDir() (string, error) {
	if arg.RouterDir == "" {
...
func (arg *HzArgument) GetClientDir() (string, error) {
	if arg.ClientDir == "" {
		return "", nil
	}
...
func (arg *HzArgument) InitManifest(m *meta.Manifest) {
...
func (arg *HzArgument) UpdateManifest(m *meta.Manifest) {
	m.Version = meta.Version
	if arg.HandlerDir != m.HandlerDir {
		m.HandlerDir = arg.HandlerDir
	}
